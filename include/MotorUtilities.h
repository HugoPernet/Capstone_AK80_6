...
Joint_origines HomingL(MotorReply reply,float threshold,MotorCommand command){
...
Joint_origines HomingR(MotorReply reply,float threshold,MotorCommand command){
