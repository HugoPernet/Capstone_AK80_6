...
As = 2; Al = 1; Ss = 1; L1 = 4.5; L2 = 2.5;
shoulder = As*(1/pi)*atan(rad2deg(x-midpoint)-10) + As/2;
leg = Al*(1/pi)*atan(-rad2deg(x+midpoint) +10)- As/2 - 2*Ss+1;
switching = -4*(1/pi)*atan(rad2deg(imu)-20)+1 ;
limit1 = -L1*(1/pi)*atan(rad2deg(x+midpoint)+180)+L1/2;
limit2 = -L2*(1/pi)*atan(rad2deg(x-midpoint)-180)-L2/2;
